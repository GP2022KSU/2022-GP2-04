...
TinyGPSPlus gps;
SoftwareSerial SerialGPS(1,3); //tx,rx
...
float calibration = 0.05; // Accuracy
int bat_percentage;
...
void loop()
{
  ...
  // ------------- Reading battary -----------------
    ...
    float voltage = (((sensorValue * 4.2) / 1024) * 2 + calibration); //multiply by two as voltage divider network is 100K & 100K Resistor
